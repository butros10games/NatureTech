...
class pirStateAdmin(admin.ModelAdmin):
    list_display = ('ip_adress', 'PIR_state', 'date')  # Fields to display in the list view

admin.site.register(pirState, pirStateAdmin)

class BtMACAdressAdmin(admin.ModelAdmin):
    list_display = ('ip_adress', 'hostname', 'BLE_rssi', 'BLE_adress', 'BLE_name', 'BLE_count', 'date')  # Fields to display in the list view
